...
# I generated an interactive leaflet map of Sumatra
#I was going to use this as my main visualisation but unfortunately, neither my PC nor those at the University had sufficient RAM storage (32GB) to knit it to HTML,
#However, I was able to generate it in both the r notebook and rmarkdown, so I thought I would include it in the code, as I feel it answers the research questions and demonstrates exactly what I wanted to achieve with this project alongside the other visualisations
